...
const schema = z.object({
    email: z.string().email('Invalid email address').min(3, 'Email is too short').nonempty('Email is required'),
    ...
    <div class="flex items-center justify-center py-12">
        <div class="mx-auto grid w-[350px] gap-6">
            ...
            <Button variant="outline" class="w-full" @click.prevent="googleAuth()">
                <NuxtImg src="https://i.pinimg.com/originals/ca/2f/7d/ca2f7db280e9c773e341589a81c15082.png"
                    width="20" />
