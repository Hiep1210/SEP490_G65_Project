...
export const columns: ColumnDef<Discount>[] = [
    ...
    },
    {
        ...
        header: 'ID',
        cell: ({ row}) => h('div', { class: 'uppercase'}, row.getValue('discountId')),
    },
    {
        accessorKey: 'discountName',
        header: 'Name',
        cell: ({ row }) => h('div', { class: 'capitalize'}, row.getValue('discountName')),
    },
    {
        accessorKey: 'discountPercent',
        header: 'Percent',
        cell: ({ row }) => h('div', { class: 'capitalize'}, row.getValue('discountPercent') + "%"),
    },
    {
        accessorKey: 'action',
        header: '',
